...
playlists_offest = input("\nEnter the playlist position (integer) you want to start searching from: ")
...
user_playlists = sp.current_user_playlists(offset=playlists_offest)
...
print(f"\nTracks to add in new playlist: {playlist_items_add}")
